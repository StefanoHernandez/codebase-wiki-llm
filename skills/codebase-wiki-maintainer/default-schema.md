...
This file is the repo-specific constitution for the wiki. Codex reads it before
wiki operations and follows these rules over plugin defaults.
...
- Build artifacts, dependency folders, generated outputs, logs, caches, and binaries.
...
- Glossary entries for project-specific terms that are not obvious to a new contributor.

## Decay policy

- Fast decay: `modules/*`, `architecture/data-model.md`, `overview.md`.
- Slow decay: `architecture/decisions.md`, `glossary.md`.
- Lower confidence when source files listed in frontmatter have changed and the page has not been re-verified.
