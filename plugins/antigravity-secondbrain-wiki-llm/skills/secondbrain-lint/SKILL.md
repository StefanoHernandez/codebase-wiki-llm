...
description: Run a read-only health check for a SecondBrain vault. Use when the user says /secondbrain-lint, secondbrain lint, audit vault, or check secondbrain health.
---
