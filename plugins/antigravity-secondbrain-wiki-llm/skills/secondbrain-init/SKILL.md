...
description: Bootstrap an adaptive personal and work knowledge vault. Use when the user says /secondbrain-init, secondbrain init, initialize second brain, bootstrap vault, or asks to start a personal/work knowledge vault.
---
